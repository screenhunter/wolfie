...
const Client = function (config, dependencies) {
    ...
    client._plugins.addHook('handlers', function (module$2, handlers) {
...
Client.prototype.ctcp = function () {
    this._outputSocket.ctcp.apply(this._outputSocket, arguments);
    return this;
};
...
Client.prototype.notice = function () {
    this._outputSocket.notice.apply(this._outputSocket, arguments);
    return this;
};
...
Client.prototype.who = function () {
    this._outputSocket.who.apply(this._outputSocket, arguments);
    return this;
};
...
Client.prototype.getModule = function () {
    this._plugins.moduleExports.apply(this._plugins, arguments);
    return this;
};
Client.prototype.getRole = function () {
    this._plugins.roleExports.apply(this._plugins, arguments);
    return this;
};
...
Client.prototype.isPluginInitializable = function () {
    this._plugins.isInitializable.apply(this._plugins, arguments);
    return this;
};
...
//# sourceMappingURL=../sourcemaps/lib/client.js.map